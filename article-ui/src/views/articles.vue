...
import { BLogParams} from "@/types/iBlog";
...
export default class Articles extends Vue {
  ...
  private params: BLogParams = {
    state: 1, // 文章发布状态 => 0 草稿，1 已发布,'' 代表所有文章
    tagId: getQueryStringByName("tag_id"),
    pageNum: 1,
    pageSize: 10
  };
  private href: string =
  ...
  routeChange(val: Route, oldVal: Route): void {
    ...
    this.params.tagId = getQueryStringByName("tag_id");
    this.articlesList = [];
